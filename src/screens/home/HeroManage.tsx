 ...
 * ## 무대에 **다 얹는다**
 *
 * 인물 둘레의 빈 자리를 글이 쓴다. 역할과 패시브는 왼쪽 위, 코스튬·인연·
 ...
 * ## 배경은 안 깐다
 *
 * 시안에는 아치가 그려진 배경이 있지만 우리는 안 쓴다. 그 그림이 없기도 하고,
 * 1-bit 에서 흰 선으로 그린 배경은 흰 선으로 그린 인물과 **같은 밝기로
 * 다투기** 때문이다. 뒤는 그냥 어둡다 (`SURF.down`).
 */
      ...
      >
        ...
        */}
        ...
        {/*
          ...
          저 둘이 생길 자리가 **이 화면의 어디인지**가 지금 정해져 있어야
          나중에 화면을 다시 안 짜기 때문이다.
