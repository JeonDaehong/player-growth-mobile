...
이전: [선술집 점원](npc-10-선술집-점원.md) · 다음: [수렵꾼](npc-12-수렵꾼.md)
...
슬라이서를 태우지 않습니다 — 원본 그대로 `assets/wallpaper/npc_beastwood/lv3.jpg` 처럼
...
1. **위 §F11 와 §B11 시트를 레퍼런스로 첨부하세요.** 픽셀 그림이지만 머리 모양·
...
THE SETTING: a dark dense forest, close-packed trunks, low fog between the trees, one shaft of cold light, undergrowth.
