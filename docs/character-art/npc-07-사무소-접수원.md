...
이전: [복권 판매원](npc-06-복권-판매원.md) · 다음: [투기장 진행자](npc-08-투기장-진행자.md)
...
슬라이서를 태우지 않습니다 — 원본 그대로 `assets/wallpaper/npc_office/lv3.jpg` 처럼
...
1. **위 §F7 와 §B7 시트를 레퍼런스로 첨부하세요.** 픽셀 그림이지만 머리 모양·
...
THE SETTING: a guild office, a cork board wall dense with pinned quest notices, a counter, stacked ledgers, a desk lamp.
