...
이전: [상점 점원](npc-09-상점-점원.md) · 다음: [숲 순찰대원](npc-11-숲-순찰대원.md)
...
슬라이서를 태우지 않습니다 — 원본 그대로 `assets/wallpaper/npc_maid/lv3.jpg` 처럼
...
1. **위 §F10 와 §B10 시트를 레퍼런스로 첨부하세요.** 픽셀 그림이지만 머리 모양·
...
THE SETTING: a warm crowded tavern, hearth fire, long timber tables, hanging mugs, lamplight and drifting smoke.
