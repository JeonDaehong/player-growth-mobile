...
이전: [숲 순찰대원](npc-11-숲-순찰대원.md) · 다음: [탑지기](npc-13-탑지기.md)
...
슬라이서를 태우지 않습니다 — 원본 그대로 `assets/wallpaper/npc_hunt/lv3.jpg` 처럼
...
1. **위 §F12 와 §B12 시트를 레퍼런스로 첨부하세요.** 픽셀 그림이지만 머리 모양·
...
THE SETTING: a scrubby hunting ground at dusk, tall dry grass, animal tracks, a distant treeline.
