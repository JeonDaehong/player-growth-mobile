...
이전: [망치 든 메이드](pc-06-망치-든-메이드.md) · 다음: [은빛 백기사](pc-08-은빛-백기사.md)
...
**[§P0](02-플레이어-흉상.md) 의 7번 칸을 레퍼런스로 첨부하세요.**
...
`assets/sprites/pc_splash/pc_witch.png` 로 바로 넣으세요.

**[§P0](02-플레이어-흉상.md) 의 7번 칸과 위 §P7 시트를 레퍼런스로 첨부하세요.**
