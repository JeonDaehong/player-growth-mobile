...
이전: [투기장 진행자](npc-08-투기장-진행자.md) · 다음: [선술집 점원](npc-10-선술집-점원.md)

| | |
|---|---|
| id | `npc_shop` |
| 장소 | 상점 |
| 말투 | 싹싹하다. 존댓말로 빠르게 말한다 |
| 선물 테마 | 잘 팔리는 물건 · 좋은 저울 |
| 호감도 MAX 혜택 | 하루 무료 물 1회 → 3회 |
...
슬라이서를 태우지 않습니다 — 원본 그대로 `assets/wallpaper/npc_shop/lv3.jpg` 처럼
...
1. **위 §F9 와 §B9 시트를 레퍼런스로 첨부하세요.** 픽셀 그림이지만 머리 모양·
...
THE SETTING: a general store interior, shelves of jars and rolled scrolls, a wooden counter with a brass scale, a swinging sign.
