...
이전: [무기 수집가](pc-09-무기-수집가.md) · 다음: [북부의 대공](pc-11-북부의-대공.md)
...
**[§P0](02-플레이어-흉상.md) 의 10번 칸을 레퍼런스로 첨부하세요.**
...
`assets/sprites/pc_splash/pc_priestess.png` 로 바로 넣으세요.

**[§P0](02-플레이어-흉상.md) 의 10번 칸과 위 §P10 시트를 레퍼런스로 첨부하세요.**
