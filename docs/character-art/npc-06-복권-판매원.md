...
이전: [오락실 딜러](npc-05-오락실-딜러.md) · 다음: [사무소 접수원](npc-07-사무소-접수원.md)
...
| 장소 | 복권상점 |
| 말투 | 텐션이 과장됐다. 감탄사가 많다 |
| 선물 테마 | 반짝이는 것 · 꽝 복권 수집 |
| 호감도 MAX 혜택 | 하루 복권 구매 한도 +1장 |
...
슬라이서를 태우지 않습니다 — 원본 그대로 `assets/wallpaper/npc_lottery/lv3.jpg` 처럼
...
1. **위 §F6 와 §B6 시트를 레퍼런스로 첨부하세요.** 픽셀 그림이지만 머리 모양·
...
THE SETTING: a tiny bright ticket booth, a wall of numbered pigeonholes behind her, a drum of tickets, streamers.
