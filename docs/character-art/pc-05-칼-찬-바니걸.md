...
이전: [견습 마도사](pc-04-견습-마도사.md) · 다음: [망치 든 메이드](pc-06-망치-든-메이드.md)
...
**[§P0](02-플레이어-흉상.md) 의 5번 칸을 레퍼런스로 첨부하세요.**
...
`assets/sprites/pc_splash/pc_bunny.png` 로 바로 넣으세요.

**[§P0](02-플레이어-흉상.md) 의 5번 칸과 위 §P5 시트를 레퍼런스로 첨부하세요.**
