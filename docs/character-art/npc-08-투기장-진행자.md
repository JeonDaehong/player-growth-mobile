...
이전: [사무소 접수원](npc-07-사무소-접수원.md) · 다음: [상점 점원](npc-09-상점-점원.md)

| | |
|---|---|
| id | `npc_arena` |
| 장소 | 투기장 |
| 말투 | 호탕하고 시끄럽다. 외치듯 말한다 |
| 선물 테마 | 싸움 기록 · 좋은 붕대 |
| 호감도 MAX 혜택 | 투기장 하루 시도 +1회 |
...
슬라이서를 태우지 않습니다 — 원본 그대로 `assets/wallpaper/npc_arena/lv3.jpg` 처럼
...
1. **위 §F8 와 §B8 시트를 레퍼런스로 첨부하세요.** 픽셀 그림이지만 머리 모양·
...
THE SETTING: an arena stands at dusk, sand floor, banners, a raised announcer platform, crowd silhouettes out of focus behind.
