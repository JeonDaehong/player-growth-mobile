...
이전: [탑지기](npc-13-탑지기.md) · 다음: [연금술사](npc-15-연금술사.md)

| | |
|---|---|
| id | `npc_abyss` |
| 장소 | 심연 |
| 말투 | 어둡고 담담하다. 감정을 잘 안 드러낸다 |
| 선물 테마 | 심연에서 건진 것 · 등불 기름 |
| 호감도 MAX 혜택 | 심연 진입 시 첫 층 건너뛰기 |
...
슬라이서를 태우지 않습니다 — 원본 그대로 `assets/wallpaper/npc_abyss/lv3.jpg` 처럼
...
1. **위 §F14 와 §B14 시트를 레퍼런스로 첨부하세요.** 픽셀 그림이지만 머리 모양·
...
THE SETTING: the lip of an enormous black chasm, broken ground, a rope ladder disappearing into the dark, updraft catching cloth.
