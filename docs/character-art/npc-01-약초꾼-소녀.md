...
이전: [떠돌이 광대](pc-12-떠돌이-광대.md) · 다음: [숲의 엘프](npc-02-숲의-엘프.md)
...
| 말투 | 밝고 부지런하다. 말끝을 올린다 |
| 선물 테마 | 고급 채집 재료 · 예쁜 돌 |
| 호감도 MAX 혜택 | 채집 1회당 결과물 +1 확률 소폭 상승 |
...
슬라이서를 태우지 않습니다 — 원본 그대로 `assets/wallpaper/npc_gather/lv3.jpg` 처럼
...
1. **위 §F1 와 §B1 시트를 레퍼런스로 첨부하세요.** 픽셀 그림이지만 머리 모양·
...
THE SETTING: a sunlit forest clearing, moss-covered rocks, herb beds, shafts of light through the canopy.
